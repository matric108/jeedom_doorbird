...
sendVarToJS('eqType', 'doorbird');
$eqLogics = eqLogic::byType('doorbird');
        ...
        <span style="font-size : 1.1em;position:relative; top : 15px;word-break: break-all;white-space: pre-wrap;word-wrap: break-word;"><center>Ajouter</center></span>
                ...
                foreach ($eqLogics as $eqLogic) {
                  ...
                  echo "<center>";
                    ...
                    echo '<img src="plugins/doorbird/doc/images/' . $path . '.png" height="105" width="95" />';
                    echo "</center>";
        ...
        <div class="row">
            ...
            <fieldset>
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">{{Nom du doorbird}}</label>
                    <div class="col-md-3">
                ...
                <form class="form-horizontal">
                  ...
                  <div class="form-group">
                  <label class="col-md-2 control-label">{{Utilisateur du doorbird}}</label>
                  <div class="col-md-3">
            ...
            <div class="form-group">
            <label class="col-md-2 control-label">{{Mot de passe du doorbird}}</label>
            <div class="col-md-3">
...
<?php include_file('desktop', 'doorbird', 'js', 'doorbird'); ?>
